<template>
  <!-- header -->
  <div
    class="nav-container page-component">
    <!--左侧导航 #start -->
    <div
      class="nav left-nav">
      <div
      ...
      <div
        class="nav-item ">
        <span :onclick="'javascript:window.location=\'/hospital/detail/'+hospital.hoscode+'\''" class="v-link clickable dark"> 医院详情 </span>
      </div>
      <div
        class="nav-item">
        <span :onclick="'javascript:window.location=\'/hospital/notice/'+hospital.hoscode+'\''" class="v-link clickable dark"> 预约须知 </span>
      </div>
      <div
        class="nav-item "><span
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <div
                class="space"><span class="label">放号时间：</span><span>{{ bookingRule.releaseTime }}</span></div>
              <div
                class="space"><span class="label">停挂时间：</span><span>{{ bookingRule.stopTime }}</span></div>
            </div>
            <div
              class="line"><span class="label">退号时间：</span>
            ...
            <div
              style="margin-top:20px"> 医院预约规则</div>
            <div
              class="rule-wrapper">
              <ol>
                <li
        ...
        <div
          class="title select-title"> 选择科室</div>
        <div
          class="select-dept-wrapper">
          <div
            class="department-wrapper">
            <div
              class="hospital-department">
              <div
          ...
          <div
            ...
            <div
              ...
              <div
                class="sub-title">
                <div
                class="block selected"/>{{ item.depname }}
              </div>
              <div
